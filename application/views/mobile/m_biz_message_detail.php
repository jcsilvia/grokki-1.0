	...
	<div data-role="content">
		<div>
			<label for="messagearea">
					...
					Business Name: <?php  echo $business->BusinessName ?><br/>
					Contact Name: <?php  echo $business->ContactName ?><br/>
					Phone: <?php  echo $phone ?><br/>
					Address: <?php echo $business->Address1 ?>
						<?php if($business->Address2) { echo ', '; echo $business->Address2; } ?><br/>
					<?php echo $business->City ?>, <?php echo $business->State ?> <?php echo $business->Zipcode ?>
					<br/><br/>
